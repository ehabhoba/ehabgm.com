...
export const metadata: Metadata = {
  title: "إعلانات ممولة حلوان | ehabgm - أفضل عائد استثمار ROI",
  description:
    "حملات إعلانية مربحة على فيسبوك وجوجل. خبراء معتمدون من Meta وGoogle. عائد استثمار مضمون. استشارة مجانية!",
  keywords: "إعلانات ممولة حلوان، إعلانات فيسبوك، إعلانات جوجل، Google Ads، Meta Ads، ehabgm",
  openGraph: {
    title: "إعلانات ممولة حلوان | ehabgm - عائد استثمار مضمون",
    description: "حملات إعلانية مربحة. خبراء معتمدون. استشارة مجانية!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "إعلانات ممولة احترافية - ehabgm",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "إعلانات ممولة حلوان | ehabgm",
    description: "حملات إعلانية مربحة. خبراء معتمدون. استشارة مجانية!",
  },
  alternates: {
    canonical: "https://ehabgm.com/paid-ads",
  },
}
