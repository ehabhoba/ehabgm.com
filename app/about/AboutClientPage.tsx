        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              ehabgm - مصمم جرافيك محترف في حلوان متخصص في التسويق الرقمي والتصميم الجرافيكي. نعمل أونلاين مع عملاء من
              جميع أنحاء مصر والعالم، ونقدم خدمات تسويقية متكاملة تساعد الشركات على النمو والازدهار في العالم الرقمي.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  ...
                  قوة التسويق الرقمي والتصميم الجرافيكي الاحترافي لتنمية أعمالها. كمصمم جرافيك محترف، بدأنا برؤية تحويل
                  الأفكار إلى تصاميم جذابة.
                </p>
                <p>
                  من خلال الشغف والالتزام، تمكنا من بناء فريق متخصص وتطوير خدماتنا لتشمل جميع جوانب التسويق الرقمي
                  وتطوير المواقع والتطبيقات. نعمل أونلاين مما يسمح لنا بخدمة عملاء من جميع أنحاء العالم بكفاءة واحترافية
                  عالية.
                </p>
                <p>
                  اليوم، نفخر بخدمة أكثر من 500 عميل وإنجاز أكثر من 1000 مشروع ناجح، مما جعلنا الخيار الأول للشركات التي
                  تسعى للنمو الرقمي والتصاميم الاحترافية. ehabgm ليس مجرد مصمم جرافيك، بل شريك استراتيجي في نجاح عملائك.
                </p>
              </div>
            </div>
