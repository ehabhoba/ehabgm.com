...
export const metadata: Metadata = {
  title: "إدارة سوشيال ميديا حلوان | ehabgm - زيادة متابعين حقيقيين",
  description: "إدارة احترافية لحساباتك على فيسبوك وانستجرام وتيك توك. 500+ حساب مُدار، +2M متابع جديد. ابدأ الآن!",
  keywords: "إدارة سوشيال ميديا حلوان، فيسبوك، انستجرام، تيك توك، زيادة متابعين، ehabgm",
  openGraph: {
    title: "إدارة سوشيال ميديا حلوان | ehabgm",
    description: "إدارة احترافية لحساباتك. 500+ حساب مُدار، +2M متابع جديد. ابدأ حملتك!",
  ...
  twitter: {
    ...
    title: "إدارة سوشيال ميديا حلوان | ehabgm",
    description: "إدارة احترافية لحساباتك. 500+ حساب مُدار. ابدأ حملتك!",
  },
  alternates: {
    canonical: "https://ehabgm.com/social-media",
  },
}
