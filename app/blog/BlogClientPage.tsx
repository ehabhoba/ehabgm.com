...
export default function BlogClientPage() {
  ...
  const categories = [
    ...
    { id: "digital-marketing", name: "التسويق الرقمي", count: 10 },
    { id: "social-media", name: "السوشيال ميديا", count: 8 },
    { id: "web-development", name: "تطوير المواقع", count: 6 },
    { id: "seo", name: "تحسين محركات البحث", count: 4 },
    { id: "ai-marketing", name: "التسويق بـ AI", count: 3 },
    { id: "video-marketing", name: "تسويق الفيديو", count: 1 },
  ]

  const featuredPost = {
    id: 1,
    title: "دليل شامل للتسويق عبر السوشيال ميديا في 2025",
    excerpt:
      "تعرف على أحدث استراتيجيات التسويق عبر منصات التواصل الاجتماعي وكيفية بناء حضور قوي لعلامتك التجارية باستخدام أحدث الأدوات والتقنيات",
  ...
  const blogPosts = [
    {
      id: 2,
      title: "كيفية تحسين موقعك لمحركات البحث في 2025",
      excerpt: "خطوات عملية لتحسين ترتيب موقعك في نتائج البحث وزيادة الزيارات المجانية باستخدام أحدث تقنيات SEO",
    ...
    {
      id: 3,
      title: "أفضل ممارسات تصميم المواقع الإلكترونية 2025",
      excerpt: "تعرف على أحدث اتجاهات تصميم المواقع وكيفية إنشاء تجربة مستخدم مميزة تزيد من التحويلات",
    ...
    {
      id: 4,
      title: "استراتيجيات الإعلانات الممولة على فيسبوك 2025",
      excerpt: "كيفية إنشاء حملات إعلانية ناجحة على فيسبوك وتحقيق أفضل عائد على الاستثمار باستخدام الذكاء الاصطناعي",
    ...
    },
    {
      ...
      excerpt: "خطوات إنشاء هوية بصرية قوية ومتماسكة تعكس قيم علامتك التجارية وتميزك عن المنافسين",
    ...
    {
      id: 6,
      title: "التجارة الإلكترونية: دليل البداية الشامل 2025",
      excerpt: "كل ما تحتاج معرفته لبدء متجرك الإلكتروني وتحقيق النجاح في التجارة الرقمية مع أحدث الأدوات",
    ...
    },
    {
      ...
      excerpt: "كيفية استخدام البيانات والذكاء الاصطناعي لاتخاذ قرارات تسويقية ذكية وتحسين الأداء",
