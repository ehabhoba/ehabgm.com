...
export const metadata: Metadata = {
  title: "تصميم مواقع احترافية حلوان | ehabgm - أسعار تنافسية 2025",
  description: "تصميم مواقع سريعة ومتجاوبة في حلوان. خبرة +8 سنوات، 200+ موقع، دعم 24/7. احصل على عرض مجاني الآن!",
  keywords: "تصميم مواقع حلوان، مواقع احترافية القاهرة، تطوير ويب، مواقع متجاوبة، ehabgm",
  openGraph: {
    title: "تصميم مواقع احترافية حلوان | ehabgm",
    description: "مواقع سريعة ومتجاوبة مع SEO محسّن. 200+ موقع مكتمل. احصل على عرض مجاني!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "تصميم مواقع احترافية - ehabgm",
      },
    ],
  },
  twitter: {
    ...
    title: "تصميم مواقع احترافية حلوان | ehabgm",
    description: "مواقع سريعة ومتجاوبة مع SEO محسّن. احصل على عرض مجاني!",
  },
  alternates: {
    canonical: "https://ehabgm.com/website-design",
  },
}
...
export default function WebsiteDesignPage() {
  const features = [
    ...
    { icon: Zap, title: "سرعة فائقة", description: "تحميل سريع وأداء محسّن" },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "تصميم مواقع احترافية سريعة ومتجاوبة مع تحسين محركات البحث",
            provider: {
              "@type": "LocalBusiness",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "تصميم المواقع",
                item: "https://ehabgm.com/website-design",
              },
            ],
          }),
        }}
