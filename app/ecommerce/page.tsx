...
export const metadata: Metadata = {
  title: "تصميم متجر إلكتروني حلوان | ehabgm - ابدأ البيع اليوم",
  description: "متاجر إلكترونية احترافية مع أنظمة دفع آمنة. باقات تبدأ من 15,000 جنيه. دعم فني مجاني. استشارة مجانية!",
  keywords: "تصميم متجر إلكتروني حلوان، متجر أونلاين، التجارة الإلكترونية، WooCommerce، Shopify، ehabgm",
  openGraph: {
    title: "تصميم متجر إلكتروني حلوان | ehabgm",
    description: "متاجر احترافية مع أنظمة دفع آمنة. باقات من 15,000 جنيه. استشارة مجانية!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "تصميم متجر إلكتروني - ehabgm",
      },
    ],
  },
  twitter: {
    ...
    title: "تصميم متجر إلكتروني حلوان | ehabgm",
    description: "متاجر احترافية مع أنظمة دفع آمنة. استشارة مجانية!",
  },
  alternates: {
    canonical: "https://ehabgm.com/ecommerce",
  },
}
