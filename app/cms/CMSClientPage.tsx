          ...
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                onClick={() => window.open(`https://wa.me/201022679250?text=${whatsappMessage}`, "_blank")}
              >
              ...
              >
                ...
                <CardContent>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        `https://wa.me/201022679250?text=${encodeURIComponent(`أريد الاستفسار عن ${pkg.name} لأنظمة إدارة المحتوى`)}`,
                        "_blank",
                      )
                    }
                  >
