...
export const metadata: Metadata = {
  title: "تحسين محركات البحث SEO حلوان | ehabgm - تصدر جوجل",
  description: "خدمات SEO احترافية لتصدر نتائج جوجل. زيادة 300% في الزيارات، 85% صفحة أولى. تحليل مجاني لموقعك!",
  keywords: "تحسين محركات البحث حلوان، SEO القاهرة، تصدر جوجل، زيادة زيارات، ehabgm",
  openGraph: {
    title: "تحسين محركات البحث SEO حلوان | ehabgm",
    description: "خدمات SEO احترافية. زيادة 300% في الزيارات. تحليل مجاني لموقعك!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "تحسين محركات البحث SEO - ehabgm",
      },
    ],
  },
  twitter: {
    ...
    title: "تحسين محركات البحث SEO حلوان | ehabgm",
    description: "خدمات SEO احترافية. زيادة 300% في الزيارات. تحليل مجاني!",
  },
  alternates: {
    canonical: "https://ehabgm.com/seo",
  },
}
